...
<tbody>
         ...
         <tr> <td id=1><a href="section_choice.php">first year</a></td><td id=2><a href="section_choice.php">second year</a></td><td id=3><a href="section_choice.php">third year</a></td>
          <td id=4><a href="section_choice.php">forth year</a></td></tr>
...
var divE1 = document.querySelectorAll('td');
  ...
  {//alert(e.currentTarget.id);
    document.cookie="year="+e.currentTarget.id;
