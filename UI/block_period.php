...
<tbody>
         ...
         <tr> <td id=0><a href="block_day.php">MONDAY</a></td><td id=1><a href="block_day.php">TUESDAY</a></td><td id=2><a href="block_day.php">WEDNESDAY</a></td>
          <td id=3><a href="block_day.php">THURSDAY</a></td><td id=3><a href="block_day.php">FRIDAY</a></td></tr>
...
var divE1 = document.querySelectorAll('td');
    ...
    for(var i = 0, len = divE1.length; i < len-3;i+=4){
    divE1[i].addEventListener("click",func,false);
    divE1[i+1].addEventListener("click",func,false);
    divE1[i+2].addEventListener("click",func,false);
    divE1[i+3].addEventListener("click",func,false);
  ...
  {//alert(e.currentTarget.id);
    document.cookie="day="+e.currentTarget.id;
